...
/**
 * Controller that organizes everything for the user. All the user related
 * mapping like editing and adding are stored in this controller.
 *
 * @author David
 */
@Controller
...
public class UserController {
    ...
    /**
     * Get the user for editing a user object. Check if a user is logged in by
     * checking the session for a user object. If so, a new edituser view is
     * showed to the client and the fields are filled with the user's data.
     *
     * @param session - the session to check if a user object exists in the
     * session.
     * @param id - the id to get the right user.
     * @return editUserView or loginView. First for the update, second if no
     * user is logged in.
     * @throws IOException
     */
    ...
    /**
     * Get the user password. Update page for a password change. First check if
     * the user is logged into the session. If true show the update page, false
     * show the login page. get the user and update it's password.
     *
     * @param session - the session to check if a user object exists in the
     * session.
     * @param id - the id to get the right user
     * @return - editUserView if the user is found in the session. loginView
     * otherwise.
     * @throws IOException
     */
    ...
    /**
     * Post of the password view. Get the user's details and update the password
     * column.
     *
     * @param user - the user to update
