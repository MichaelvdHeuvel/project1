<%-- 
    Document   : resources
    Created on : 18-okt-2014, 14:10:20
    Author     : Tim
--%>

<%@tag description="resources" pageEncoding="UTF-8"%>
...
<link href="<%=request.getContextPath()%>/resources/css/plugins/dataTables.bootstrap.css" rel="stylesheet">
