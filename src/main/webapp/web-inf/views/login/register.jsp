                    ...
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form:form method="POST" commandName="user" action="${pageContext.request.contextPath}/login/register">
                                ...
                                <div class="form-group">
                                    <form:input type="text" class="form-control" id="inputEmail3" placeholder="voornaam" path="firstName" />
                                </div>
                                
                                <div class="form-group">
                                    <form:input type="text" class="form-control" id="inputEmail3" placeholder="achternaam" path="lastName" />
                                </div>
